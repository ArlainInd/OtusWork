...
insert into books (bookid, name, authorid) values (4, 'seeker', 2001);
...
insert into authors (authorid, name, country, birthdate) values (3002, 'Джордж Мартин', 'США', '1948-11-20');
